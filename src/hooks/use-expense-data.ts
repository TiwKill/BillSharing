...
import { PERSON_COLORS, STORAGE_KEYS } from "@/lib/constants"
import type { Person, Expense, PersonSummary, Settlement } from "@/types/index"

/**
 * Custom hook for managing expense data with localStorage persistence
 * Provides CRUD operations for people and expenses, plus calculation functions
 */
